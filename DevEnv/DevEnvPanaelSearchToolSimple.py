...
from VisualDetectionToolLibrary.PanelSearchToolV20 import PanelBoardSearch

# Inputs/Outputs
INPUT_PDF = Path("~/Documents/pdfToScan/C.pdf").expanduser()
OUT_DIR   = Path("~/Documents/pdfScanTest3").expanduser()
